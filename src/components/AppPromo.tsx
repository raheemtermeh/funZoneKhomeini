...
const userFeatures = [
  {
    icon: "📅",
    title: "رزرو آنی",
    desc: "صندلی خود را در محبوب‌ترین رویدادها فورا رزرو کنید.",
  },
  {
    icon: "💸",
    title: "تخفیف‌های اختصاصی",
    desc: "از تخفیف‌های ویژه کاربران اپلیکیشن بهره‌مند شوید.",
  },
  {
    icon: "🏆",
...
const businessFeatures = [
  {
    ...
    desc: "رویدادهای خود را به سادگی ایجاد و مدیریت کنید.",
  },
  {
    icon: "📈",
  ...
  },
  {
    ...
    desc: "آمار دقیق رزروها و درآمد خود را مشاهده کنید.",
  },
];
...
const testimonials = [
  ...
  {
    name: "علی",
    text: "اپلیکیشن خیلی روون و کاربردیه. رزرو کردن کمتر از یک دقیقه طول می‌کشه.",
    role: "کاربر",
  },
];
